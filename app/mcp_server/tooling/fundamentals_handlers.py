...
def _register_fundamentals_tools_impl(
    ...
    @mcp.tool(
        ...
        description=(
            ...
            "If any dated opinion falls outside the window, or if no opinion "
            "survives it, target stats and upside_pct are null — remaining "
            "in-window rows are not a silent refresh (check rows_total, "
            "rows_used, rows_excluded_stale, newest_opinion_date, window_months). "
