"""KR/US equity quotes: Toss live first, then persisted daily candles.

Single and batch quote endpoints share this priority. Provider failures degrade
to persisted candles without fabricating a quote timestamp; ``source`` and
``asOf`` preserve the actual evidence used.
"""
