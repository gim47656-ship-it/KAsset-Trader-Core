RECORD:
DATE: 2026-09-07
SCOPE: -3% 손절 바닥, optional initial_atr, 손절선 floor, 수동 단계 배포
PATHS: app/extensions/kasset/automation/position_manager.py, app/extensions/kasset/automation/position_manager_service.py, app/extensions/kasset/models.py, alembic/versions/20260907_kasset_position_state_optional_atr.py, tests/_schema_bootstrap.py, tests/extensions/kasset/automation/test_position_manager.py
STATUS: superseded-by doc/history/2026/09/16-stop-floor-removal/main.md

병합: PR 없이 `main`에 직접 push(`9fefab61e80a6ade8466669e75e06cdc975a95fb`), 2026-09-07 운영 배포 완료. 이 기록의 -3% 바닥 계약은 2026-09-16 `19e626086`(PR #66)에서 제거됐다.
